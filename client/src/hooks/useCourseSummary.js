...
export function useCourseSummary(courseId) {
    ...
    const fetchCourseDetails = async () => {
        ...
        try {
            const response = await axios.get(`${domain}:4000/api/courses/${courseId}/course-details`, { withCredentials: true });
    ...
    const fetchStudents = async () => {
        ...
        try {
            const response = await axios.get(`${domain}:4000/api/courses/${courseId}/students`, { withCredentials: true });
